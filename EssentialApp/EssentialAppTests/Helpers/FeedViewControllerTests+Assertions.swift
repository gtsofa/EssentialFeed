...
extension FeedUIIntegrationTests {
    func assertThat(_ sut: ListViewController, isRendering feed: [FeedItem], file: StaticString = #file, line: UInt = #line) {
    ...
    func assertThat(_ sut: ListViewController, hasViewConfiguredFor image: FeedItem, at index: Int, file: StaticString = #file, line: UInt = #line) {
