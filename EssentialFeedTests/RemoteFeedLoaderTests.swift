...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWith: .failure(.connectivity), when: {
            let clientError = NSError(domain: "Test", code: 0, userInfo: .none)
    ...
    func test_load_deliversNoItemsOn200HTTPResponseWithEmptyJSONList() {
        ...
        expect(sut, toCompleteWith: .success([]), when: {
            let emptyJSONList = Data.init(_: "{\"items\": []}".utf8)
    ...
    func test_load_deliversItemsOn200HTTPResponseWithJSONList() {
        ...
        let item2 = makeItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "https://a-nother-url.com")!)
