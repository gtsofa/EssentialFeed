...
class CodableFeedStoreCloneTests: XCTestCase {
    ...
    func test_retrieve_deliversFailureOnRetrievalError(){
        ...
        try! "invalid data".write(to: testSpecificStoreURLClone(), atomically: false, encoding: .utf8)
    ...
    private func insert(_ cache: (feed: [LocalFeedImage], timestamp: Date), to sut: CoddableFeedStoreClone) {
